                ...
                return observable
                        ...
                        .doOnSubscribe(new Consumer<Disposable>() {
                            ...
                            public void accept(final Disposable disposable) throws Exception {
                                LogHttpLibUtil.d("doOnSubscribe -- Determine if there is a network and dialog.");

                                if (!NetWorkUtils.isConnectedByState(context)) {
                                    disposable.dispose();
                                    LogHttpLibUtil.d("doOnSubscribe -- There's no network link.");
                                    Toast.makeText(context, R.string.toast_network_error, Toast.LENGTH_SHORT).show();
                                } else {
                                    LogHttpLibUtil.d("doOnSubscribe -- There's a network link.");
